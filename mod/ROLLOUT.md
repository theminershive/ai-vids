...
Or systemd:
```
sudo cp systemd/monitor.service /etc/systemd/system/mod-monitor.service
sudo systemctl daemon-reload
sudo systemctl enable --now mod-monitor.service
```
...
```
sudo cp systemd/comment.service /etc/systemd/system/mod-comment.service
sudo systemctl daemon-reload
sudo systemctl enable --now mod-comment.service
```
